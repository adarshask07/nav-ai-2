  ...
  return (
    <div className="w-full h-full bg-[#1E1E1E] flex flex-col">
      <div className="p-6 border-b border-white/5 bg-[#181818]">
         ...
         <p className="text-xs text-neutral-500 mt-1">Managed environments with strict policy enforcement.</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
        {WORKSPACES.map((ws) => (
          ...
          >
             ...
             <div className={`relative w-full py-1.5 px-3 rounded-full border flex items-center gap-2 ${
               ws.compliant 
      ...
      <div className="p-4 border-t border-white/5 bg-[#181818]">
         <button className="w-full py-2 rounded border border-dashed border-white/20 text-xs font-mono text-neutral-400 hover:text-white hover:border-white/40 transition-colors">
