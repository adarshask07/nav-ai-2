...
const EcosystemSection: React.FC = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(contentRef.current,
        ...
        { scale: 1, filter: "blur(0px)", opacity: 1, duration: 0.4, ease: "power2.out" }
      ).to(contentRef.current, 
        { scale: 1.1, filter: "blur(15px)", opacity: 0.5, duration: 0.4, ease: "power2.in" },
        ">0.2" 
      );
  ...
  return (
    <section ref={containerRef} className="relative h-[250vh] w-full bg-brand-navy z-40">
