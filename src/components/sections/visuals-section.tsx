...
const VisualsSection: React.FC = () => {
  return (
    <section className="relative w-full min-h-screen bg-brand-navy flex flex-col items-center justify-center py-24 md:py-32 overflow-hidden border-t border-white/5">
